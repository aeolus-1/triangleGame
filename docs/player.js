...
class Player extends Entity {
    ...
    updateControls() {
        ...
        if (keys[this.keyset["jump"]] && !preKeys[this.keyset["jump"]] && (this.jumpTime > 0 || infinJump)) {
        ...
        if (keys[this.keyset["jump"]] && this.jumpTime > -15 && Math.abs(this.body.velocity.y) > 4.5) {
